...
void AP_AHRS_NavEKF::update(bool skip_ins_update)
{
    ...
    //如果ins被提升，回到正常有限集调用delay_microseconds_boost
...
void AP_AHRS_NavEKF::update_DCM(bool skip_ins_update)
{
    ...
    // correction
    //需要恢复旧的DCM值，因为在DCM的内部使用陀螺漂移计算误差值来校正
