...
class Compass
{
friend class AP_Compass_Backend;//友元类
public:
    Compass();
    ...
    */
    ...
    // return last update time in microseconds  以ms为单位返回更新的时间
...
private:
    ...
    // declination in radians 弧度形式的磁偏角
    ...
    struct mag_state {
        ...
        // corrected magnetic field strength 校正后的磁场强度
        Vector3f    field;
    ...
    //定义了一个结构体数组_state[3],每一个元素都是一个mag_state类型的结构体
